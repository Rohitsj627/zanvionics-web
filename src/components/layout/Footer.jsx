        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-teal-600 rounded-full flex items-center justify-center transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
                <a href="mailto:info@zanvionics.com" className="hover:text-teal-400 transition-colors duration-300">
                  info@zanvionics.com
                </a>
              </li>
              <li>85 Great Portland Street, First Floor, London, United Kingdom, W1W 7LT</li>
              <li className="text-teal-400 font-medium">Response time: Within 24 hours</li>
            </ul>
          </div>
        </div>
